...
const TextElementOperate = ({ elementInfo, handlerVisible, rotateElement, scaleElement, dragLineElement }: IProps) => {
  ...
  return <div className="text-element-operate">
    ...
    {
      handlerVisible && textElementResizeHandlers.map(point => {
